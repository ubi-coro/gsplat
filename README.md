...
## [<img src="https://seeklogo.com/images/T/tux-logo-AA06C623EC-seeklogo.com.png" height="20" /> Installation](docs/INSTALL_LIN.md)

## [<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/87/Windows_logo_-_2021.svg/768px-Windows_logo_-_2021.svg.png" height="18" /> Build from Source on Windows](docs/INSTALL_WIN.md)
...
> [!NOTE]
>
> Full report can be found [here](https://docs.gsplat.studio/main/tests/eval.html).
...
the examples (requires to install some extra dependencies via `pip install -r examples/requirements.txt`)
